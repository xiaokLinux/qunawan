	...
	<div class="backgrounds" id="backgrounds">
		...
		<div class="content" id="div_position">
			...
			<div class="login_framework">
				...
				<form id="log_reg_form" name="loginForm" method="post" action="login">
				
					<div class="content2">
						<div id="contents" class="contents">${err_msg}</div>
						<ul>
							<li><input id="tid" name="user.phone" type="text" class="text"
								value="您的邮箱账号/手机号" /><br /></li>
						</ul>
						<ul id="pwd_p">
							<li><input type="text" name="user.password" id="pwd" class="text"
								value="您的密码" /></li>
						</ul>
